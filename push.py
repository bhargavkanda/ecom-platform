...
# IOS_GCM_API_KEY = 'AIzaSyAkvFbURzTQK4K-20RKquS03f9c4gxsNfQ'
...
def callback(ch, method, properties, body):
    ...
    for chunk in _chunks(data_req['reg_id_list'], MAX_CHUNK_LENGTH):
        ...
        response = _gcm_send(json.dumps({'data':data_req['data'], 'registration_ids':chunk}),'application/json')
        print response
        #pdb.set_trace()
