...
CitrusPay.Vault.Config = (function() {
		...
		function getVaultUrl(){			
			return codUrl + "/api/vault/tokenize/".CitrusPay.Merchant.Config.Merchant.vanityUrl;
		}				
		return {
...
function memberPayment(modeOfPayment, isToken) {	
	...
	console.log(paymentToken, "oooooooooooooooo")
	...
	console.log(paymentRequest, vanityUrl)
